...
public class EventCurve {
	...
	private static void init() {
		File file_gasdm = new File("data//output//states_flu_result_B=1segment_20_20161020_003847_filterTrue_threshold=9.txt");//1_12 13 18
		File file_nphgs = new File("data//output//NPHGS-result-flu.txt");
		File file_eventtree = new File("data//output//EventTree-result-flu.txt");
		File file_lgta = new File("data//output//LGTA-result-flu.txt");
		File file_real = new File("data//output//TrueLable-flu.txt");
